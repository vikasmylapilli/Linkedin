...
const SearchIcon = styledComponents.div`
width:40px;
position: absolute;
z-index:1;
top:10px;
...
const NavListWrap = styledComponents.ul`
display:flex;
flex-wrap:nowrap;
...
`;
const NavList = styledComponents.li`
display: flex;
align-items:center;
a{
    align-items: center;
...
`;
const User = styledComponents(NavList)`
a > svg{
    width:24px;
    border-radius:50%;
}
...
const Work = styledComponents(User)`
