...
margin-bottom:100px;
`;
const FollowCard = styledComponents.div`
text-align:center;
overflow:hidden;
margin-bottom:8px;
...
const FeedList = styledComponents.ul`
margin-top:16px;
...
margin-right: 8px;
`;
const Recommendation = styledComponents.div`
color: #0a66c2;
display: flex;
align-items: center;
font-size: 14px;
...
const BannerCard = styledComponents(FollowCard)`
img{
    width: 100%;
    height:100%;
}
